...
module.exports.getAllPost = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({message:"All post of this user", posts: user.posts});
  } catch (error) {
...
module.exports.deletePost = async (req, res) => {
    ...
    try {
        ...
        if(deletePost.deletedCount === 0){
            return res.status(400).json({message:"something went wrong. post may not exist or was not deleted."})
        }
